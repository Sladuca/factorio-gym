...
server:
	FACTORIO_PATH="/Users/seb/Library/Application Support/Steam/steamapps/common/Factorio/factorio.app/Contents/MacOS/factorio" python3 scripts/dev_server.py
...
help:
	...
	@echo "  test        - Run tests"
	@echo "  check       - Run checks (lint, type)"
